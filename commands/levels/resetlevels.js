...
module.exports = {
    // DESTRUCTION
	data: new SlashCommandBuilder().setName('resetlevels').setDescription('Resets ALL levels on the server'),
	async execute(interaction) {
        ...
        const askEmbed = new EmbedBuilder()
            .setColor(0xff3b3b)
            .setDescription(`THIS COMMAND WILL RESET ALL LEVELS FOR EVERY MEMBER IN THIS SERVER! ARE YOU SURE?`);
        const confirmedEmbed = new EmbedBuilder()
            .setColor(0x3bff3b)
            .setDescription(`All levels have been reset.`);
        const cancelledEmbed = new EmbedBuilder()
            .setColor(0x000000)
            .setDescription(`All levels have ***not*** been reset.`);
        ...
        if(interaction.member.permissions.has(PermissionsBitField.Flags.Administrator)){
            ...
            try {
                ...
                if (confirmation.customId === 'confirm') {
                    ...
                    database.collection(interaction.guild.id).updateMany({}, resetDoc);
